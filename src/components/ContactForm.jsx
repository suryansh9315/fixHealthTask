    ...
    <div className="w-[100%] lg:w-[75%] xl:w-2/3 p-10 rounded-lg bg-[#f7f7f7] dark:bg-black dark:border dark:border-gray-700 flex gap-10 flex-col items-center md:items-start">
      ...
      <div className="flex justify-between flex-col md:flex-row gap-10">
        <div className="flex flex-col gap-3 w-[250px] sm:w-[300px]">
          ...
          />
          {!occupation && (
            <div className="text-red-500">Occupation is mandatory</div>
          )}
        </div>
      ...
      <div className="flex justify-between flex-col md:flex-row gap-10">
        <div className="flex flex-col gap-3 w-[250px] sm:w-[300px]">
          ...
          />
          {!complaints && (
            <div className="text-red-500">Complaints are mandatory</div>
          )}
        </div>
        <div className="flex flex-col gap-3 w-[250px] sm:w-[300px]">
      ...
      {age > 30 && (
        <div className="flex flex-col gap-3 w-[250px] sm:w-[300px] md:w-full">
          <div className="font-bold text-lg">Experience with Physiotherapy</div>
          <input
      ...
      <div
        ...
        className="z-10 px-8 py-3 mt-5 bg-black cursor-pointer text-white dark:bg-white dark:text-black rounded-3xl font-bold w-[200px] text-center"
      >
        Book Now
      </div>
    </div>
